    ...
    var miniTab = {
        ...
        openTabRignMenu: function (tabId, left) {
            ...
            var menuHtml = '<div class="layui-unselect layui-form-select layui-form-selected layuimini-tab-mousedown layui-show" data-tab-id="' + tabId + '" style="left: ' + left + 'px!important">\n' +
                '<dl>\n' +
                '<dd><a href="javascript:;" layuimini-tab-menu-close="current">关闭当前选项卡</a></dd>\n' +
                '<dd><a href="javascript:;" layuimini-tab-menu-close="other">关闭其他选项卡</a></dd>\n' +
                '<dd><a href="javascript:;" layuimini-tab-menu-close="all">关闭全部选项卡</a></dd>\n' +
                '</dl>\n' +
                '</div>';
