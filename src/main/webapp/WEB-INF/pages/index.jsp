                ...
                <li class="layui-tab-tool layui-icon layui-icon-down">
                    <ul class="layui-nav close-box">
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd><a href="javascript:;" layuimini-tab-close="current">关闭当前选项卡</a></dd>
                                <dd><a href="javascript:;" layuimini-tab-close="other">关闭其他选项卡</a></dd>
                                <dd><a href="javascript:;" layuimini-tab-close="all">关闭全部选项卡</a></dd>
                            </dl>
                        </li>
                    </ul>
                </li>
